...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        //改变排序//edit by PC at 2014.04.15
        //changeSort: function (columnName, sortOrder)
        changeSort: function (columnName, sortOrder, sortField)
        {
            var g = this, p = this.options;
            ...
            //此处原文代码：p.sortName = columnName; 
            //---增加排序字段 add by PC at 2014.04.15---//
            if (!sortField)
        ...
        _onClick: function (e)
        {
            ...
            else if (src.hcelltext) //排序
            {
                ...
                var sortField = src.column.sort; //add by pc at 2014.04.15
                if (sort.length > 0)
                {
                    if (sort.hasClass("l-grid-hd-cell-sort-asc"))
                    {
                        ...
                        g.changeSort(columnName, 'desc', sortField); //g.changeSort(columnName, 'desc');//edit by pc at 2014.04.15
                    }
                    else if (sort.hasClass("l-grid-hd-cell-sort-desc"))
                    {
                        ...
                        g.changeSort(columnName, 'asc', sortField); //g.changeSort(columnName, 'asc');//edit by pc at 2014.04.15
                    }
                }
                else
                {
                    ...
                    g.trigger('ChangeSort', [columnName, 'asc']);
                    g.changeSort(columnName, 'asc', sortField); //g.changeSort(columnName, 'asc');
                }
